        ...
        <section className="library books howtogetstarted">
            ...
            <div className="program-card">
                ...
                <ul className="program-info-list">
                    ...
                    <img src="/Pictures/foamrolling2.jpg" alt="foamrolling" style={{width:"100px",height:"80px", border: "2px gray solid"}} /> <span></span>
                    <img src="/Pictures/foamrolling1.jpg" alt="foamrolling" style={{width:"100px",height:"80px", border: "2px gray solid"}} />
                    <li>Pre-programmed Mobility & Flexibility training regimen for Beginners, Intermediate, and/or Advanced</li>
