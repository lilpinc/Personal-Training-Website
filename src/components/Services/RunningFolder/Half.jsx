    ...
    return (
        <section className="books mobilityflexibility howtogetstarted">
            <div>
                ...
                <header>
                    <h2 id="name">Half Marathon Training Program</h2>
                </header>
                <p className="overview">Training for a half marathon but don't know where to begin or how to progress your runs each week? Maybe you want a program that also includes some strengthening exercises to reduce injury?</p>
                <p className="overview">Our half marathon training programs are right for you!</p>
