    ...
    return (
        <section className="books mobilityflexibility howtogetstarted">
         <div className="description">
            ...
            <p className="overview">For just $65 you will have access to our many videos that take you through a series of high intensity workouts ranging from 20 to 40 minutes in length!</p>
            </div>
        <div>
